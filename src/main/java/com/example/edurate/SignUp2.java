...
public class SignUp2 extends AppCompatActivity {
    ...
    private Button signupButton, backButton, transcriptButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transcriptButton = findViewById(R.id.uploadbutton);
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        if (!task.getResult().isEmpty()) {
                            ...
                            Toast.makeText(SignUp2.this, "An account with this email already exists. Please login.", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            db.collection("students")
                                    ...
                                    .addOnSuccessListener(aVoid -> {
                                        ...
                                        Intent intent = new Intent(SignUp2.this, preferences.class);
                                        intent.putExtra("aucemail", email);
                                        startActivity(intent);
                                        finish();
                                    })
                                    .addOnFailureListener(e -> {
                                        Toast.makeText(SignUp2.this, "Failed to save data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                    });
                        }
                    }
                });
