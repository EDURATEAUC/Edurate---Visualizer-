...
public class HomeStudent extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        computer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(HomeStudent.this, department.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            intent = new Intent(HomeStudent.this, Home.class);
